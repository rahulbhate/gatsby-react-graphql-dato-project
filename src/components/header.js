      ...
      <div className={styles.banner}>
        ...
        <header className={styles.container}>
          ...
          <div className={styles.headerSectionContents}>
            ...
            Uthru makes it easier for buyers and renters to find the home of their 
            dreams while saving agents time and money. <br/>Crowded open homes are a thing of the past. Inspect vacant properties independently, at your own convenience with Uthru. No agents, no set times, no hassle.
            </p>
