...
<h1 align="center">
  Gatsby's boilerplate with tech stack - React, Redux, SASS, BEM, DATO CMS
</h1>
...
1.  **Start developing.**
    ...
    ```shell
    cd gatsby-react-graphql-dato-project/
    gatsby develop
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `gatsby-react-graphql-dato-project` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
